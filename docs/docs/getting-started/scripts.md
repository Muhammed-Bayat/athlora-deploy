...
|---------|--------|--------|
| `frontend` | lint, typecheck, test, coverage, build | passing (229 Vitest/RTL and track-math tests) |
| `backend` | lint, typecheck, test, coverage, build | passing (310 Vitest/Supertest tests; 38 database tests skipped when unconfigured) |
| `docs` | build | passing |
