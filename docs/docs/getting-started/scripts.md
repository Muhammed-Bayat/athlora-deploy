...
|---------|--------|--------|
| `frontend` | lint, typecheck, test, coverage, build | passing (234 Vitest/RTL and track-math tests) |
| `backend` | lint, typecheck, test, coverage, build | passing (317 Vitest/Supertest tests; 38 database tests skipped when unconfigured) |
| `docs` | build | passing |
