...
const services = vi.hoisted(() => ({ createClub: vi.fn(), createJoinRequest: vi.fn(), listClubJoinRequests: vi.fn(), listClubs: vi.fn(), listMyJoinRequests: vi.fn(), reviewJoinRequest: vi.fn(), withdrawJoinRequest: vi.fn() }));
